...
const About = () => {
  return (
    ...
    As we continue to evolve and grow, we remain committed to our core values of authenticity, creativity, and community. Join us on this exciting journey as we strive to make Bittersweets a place where your stories matter and your voice is celebrated.
    
    Thank you for being a part of our community!</div>
  )
}
